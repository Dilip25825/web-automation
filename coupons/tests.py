...
class CouponTests(TestCase):
    ...
    def test_generator_uses_128_bit_unique_format(self):
        ...
        self.assertRegex(first, r"^CPN-[A-Z2-7]{5}-[A-Z2-7]{5}-[A-Z2-7]{5}-[A-Z2-7]{5}-[A-Z2-7]{6}$")
        self.assertNotEqual(first, second)

    def test_form_accepts_generated_code_with_independent_discount(self):
        code = generate_coupon_code(750)
        form = CouponForm({"coupon_code": code, "discount_amount": 500, "status": "on"})
