"""
Django settings for software_admin project.
...
ROOT_URLCONF = 'software_admin.urls'
...
# WSGI_APPLICATION = 'software_admin.wsgi.application'
...
# Razorpay credentials are server-side environment variables only.
...
GOOGLE_DRIVE_DOWNLOADS_FOLDER_ID = os.getenv('GOOGLE_DRIVE_DOWNLOADS_FOLDER_ID', '').strip()
GOOGLE_DRIVE_DOWNLOADS_CACHE_SECONDS = int(os.getenv('GOOGLE_DRIVE_DOWNLOADS_CACHE_SECONDS', '300'))
GOOGLE_SERVICE_ACCOUNT_FILE = os.getenv('GOOGLE_SERVICE_ACCOUNT_FILE', '').strip()
KHATA_ATTACHMENT_MAX_SIZE = 5 * 1024 * 1024
